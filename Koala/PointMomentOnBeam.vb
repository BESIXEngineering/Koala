...
Namespace Koala
    ...
    Public Class PointMomentOnBeam
        ...
        ''' </summary>
        Public Sub New()
            MyBase.New("PointMomentOnBeam", "PointMomentOnBeam",
                "PointMomentOnBeam description",
                "Load", New EsaObjectType() {EsaObjectType.PointMomentBeam})
        End Sub
        ...
        Protected Overrides Sub RegisterOutputParams(pManager As GH_Component.GH_OutputParamManager)
            pManager.AddTextParameter("PointMomentBeam", "PointMomentBeam", "PointMomentBeam data", GH_ParamAccess.list)
        End Sub
        ...
        Protected Overrides Sub SolveInstance(DA As IGH_DataAccess)
            ...
            DA.GetData(Of Double)(9, deltaX)



            Dim SE_loads(BeamList.Count, 10)
        ...
        Public Overrides ReadOnly Property ComponentGuid() As Guid
            Get
                Return New Guid("f6919f7f-23d2-4642-86b6-e9812a4bb4d6")
            End Get
        End Property
    End Class
