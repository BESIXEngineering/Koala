...
Namespace Koala
    ...
    <System.Obsolete("Use 'NodeSupport2' instead which makes better use of Grasshopper's default data matching algorithm.")>
    Public Class NodeSupport
        ...
        Protected Overrides Sub SolveInstance(DA As IGH_DataAccess)
            ...
            For Each item In NodeSupports
                FlatList.Add(item)
                NameIndex += 1
                FlatList.Add("Sn" & NameIndex.ToString())
                FlatList.Add(Tx)
                FlatList.Add(Ty)
                FlatList.Add(Tz)
                FlatList.Add(Rx)
                ...
                FlatList.Add(CoordSystemNodeSupport.GCS)
                FlatList.Add(Angle)
            Next
