    ...
    Public Class CreateXML2
        ...
        Private ReadOnly VariableParameterDict As New Dictionary(Of EsaObjectCategory, EsaObjectType()) From {
            ...
            {EsaObjectCategory.BoundaryCondition, New EsaObjectType() {
                ...
                EsaObjectType.SurfaceEdgeSupport,
        ...
        Protected Overrides Sub SolveInstance(DA As IGH_DataAccess)
            ...
            CreateXMLFile(fileName, structureTypeString, materials, GetEnumDescription(uilanguage),
                          ...
                          GetInputText(DA, EsaObjectType.SectionOn1D),
                          GetInputText(DA, EsaObjectType.SectionOn2D),
