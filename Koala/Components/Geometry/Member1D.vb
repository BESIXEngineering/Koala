...
Namespace Koala
    ...
    Public Class Member1D
        ...
        Protected Overrides Sub RegisterInputParams(pManager As GH_Component.GH_InputParamManager)
            ...
            Dim index As Integer = pManager.AddIntegerParameter("BucklingGroupIndex", "BucklingGroupIdx", "Index of the buckling group to assign (must already exist in your project!)", GH_ParamAccess.item)
            pManager.Param(index).Optional = True
        End Sub
        ...
        Protected Overrides Sub SolveInstance(DA As IGH_DataAccess)
            ...
            Dim bucklingGroupIdx As Integer = -1
            ...
            If (Not DA.GetData(5, memberNamePrefix)) Then Return
            If (Not DA.GetData(6, tolerance)) Then Return
            If (Not DA.GetData(7, remDuplNodes)) Then Return
            If DA.GetData(8, i) Then structuralType = CType(i, BeamType)
            If DA.GetData(9, i) Then FEMtype = CType(i, BeamFEMType)
            If DA.GetData(10, i) Then memberSystemLine = CType(i, MemberSystemLine)
            DA.GetData(11, ey)
            DA.GetData(12, ez)
            DA.GetData(13, bucklingGroupIdx)
        ...
        Public Overrides ReadOnly Property ComponentGuid() As Guid
            Get
                Return New Guid("730e3890-2fba-fae1-96a2-971e3bfe8dee")
            End Get
        End Property
    End Class
